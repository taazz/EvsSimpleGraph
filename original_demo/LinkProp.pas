...
class function TLinkProperties.Execute(Links: TEvsGraphObjectList): Boolean;
begin
  Result := False;
...
function TLinkProperties.GetObjectOptions: TEvsGraphObjectOptions;
var
...
procedure TLinkProperties.SetObjectOptions(Value: TEvsGraphObjectOptions);
var
  Option: TEvsGraphObjectOption;
begin
  for Option := Low(TEvsGraphObjectOption) to High(TEvsGraphObjectOption) do
...
function TLinkProperties.GetLinkOptions: TEvsGraphLinkOptions;
var
...
procedure TLinkProperties.SetLinkOptions(Value: TEvsGraphLinkOptions);
var
  Option: TEvsGraphLinkOption;
begin
  for Option := Low(TEvsGraphLinkOption) to High(TEvsGraphLinkOption) do
