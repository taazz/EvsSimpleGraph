...
uses
  ...
  Dialogs, UevsSimplegraph, ExtCtrls, StdCtrls, ComCtrls, ExtDlgs, CheckLst;
...
class function TNodeProperties.Execute(Nodes: TEvsGraphObjectList): Boolean;
begin
  Result := False;
...
function TNodeProperties.GetObjectOptions: TEvsGraphObjectOptions;
var
...
procedure TNodeProperties.SetObjectOptions(Value: TEvsGraphObjectOptions);
var
  Option: TEvsGraphObjectOption;
begin
  for Option := Low(TEvsGraphObjectOption) to High(TEvsGraphObjectOption) do
...
function TNodeProperties.GetNodeOptions: TEvsGraphNodeOptions;
var
...
procedure TNodeProperties.SetNodeOptions(Value: TEvsGraphNodeOptions);
var
  Option: TEvsGraphNodeOption;
begin
  for Option := Low(TEvsGraphNodeOption) to High(TEvsGraphNodeOption) do
